...
from src.modules.marketing.domain.exceptions import CouponDomainError, PromotionDomainError
...
class TestCoupon:
    def test_should_accept_valid_coupon(self) -> None:
    ...
    def test_should_raise_error_when_expired(self) -> None:
    ...
    def test_should_raise_error_when_used_count_negative(self) -> None:
    ...
    def test_should_raise_error_when_usage_limit_reached(self) -> None:
    ...
    def test_is_valid_returns_true_for_active_coupon(self) -> None:
...
class TestPromotion:
    def test_should_accept_valid_promotion(self) -> None:
    ...
    def test_should_raise_error_when_name_blank(self, name: str) -> None:
    ...
    def test_should_raise_error_when_end_before_start(self) -> None:
    ...
    def test_should_raise_error_when_duration_out_of_range(self, duration_days: int) -> None:
    ...
    def test_should_raise_error_when_end_in_past(self) -> None:
    ...
    def test_should_raise_error_when_start_too_far_in_future(self) -> None:
    ...
    def test_should_raise_error_when_description_too_long(self) -> None:
    ...
    def test_is_valid_returns_true_when_active_and_within_dates(self) -> None:
    ...
    def test_is_valid_returns_false_when_inactive_or_outside_dates(self) -> None:
