...
from src.modules.marketing.presentation.serializers.coupon_serializer import CouponSerializer
...
class TestCouponSerializer:
    def test_valid_coupon_serialization_returns_expected_fields(self) -> None:
...
class TestPromotionSerializer:
    def test_valid_promotion_serialization_returns_expected_fields(self) -> None:
