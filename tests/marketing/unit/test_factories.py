...
class TestCouponFactory:
    def test_from_dict_returns_valid_coupon(self) -> None:
    ...
    def test_from_dict_applies_defaults_when_fields_missing(self) -> None:
...
class TestPromotionFactory:
    def test_from_dict_returns_valid_promotion(self) -> None:
    ...
    def test_from_dict_applies_defaults_to_optional_fields(self) -> None:
