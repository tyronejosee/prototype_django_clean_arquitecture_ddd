...
from apps.marketing.application.use_cases.create_coupon import CreateCouponUseCase
from apps.marketing.application.use_cases.create_promotion import CreatePromotionUseCase
...
def test_apply_discounts_use_case_returns_discount_result() -> None:
...
def test_create_coupon_use_case_creates_valid_coupon() -> None:
...
def test_create_coupon_use_case_raises_if_code_exists() -> None:
...
def test_create_coupon_use_case_generates_code_if_missing() -> None:
...
def test_create_promotion_use_case_creates_promotion() -> None:
...
def test_get_active_coupons_use_case_returns_list() -> None:
...
def test_get_active_promotions_use_case_returns_list() -> None:
