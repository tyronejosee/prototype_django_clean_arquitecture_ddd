...
class Promotion:
    ...
    PROMOTION_INVALID_DATE_RANGE_ERROR_MSG: str = (
    ...
    PROMOTION_DURATION_TOO_LONG_ERROR_MSG: str = (
        "Promotion duration exceeds the maximum allowed."
    )
    PROMOTION_ENDS_IN_PAST_ERROR_MSG: str = "Promotion cannot end in the past."
    PROMOTION_STARTS_TOO_FAR_ERROR_MSG: str = (
        "Promotion start date is too far in the future."
    )
