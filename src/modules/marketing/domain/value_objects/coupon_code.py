...
class CouponCode:
    ...
    COUPON_CODE_LENGTH_ERROR_MSG: str = "Coupon code must be between 4 and 20 characters."
    ...
    def _validate(self) -> None:
        ...
        if len(self.value) < self.COUPON_CODE_MIN_LENGTH or len(self.value) > self.COUPON_CODE_LENGTH:
