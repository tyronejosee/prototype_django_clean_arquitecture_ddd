...
from modules.cart.domain.factories.cart_item_factory import CartItemFactory
from modules.cart.domain.value_objects.item_quantity import ItemQuantity


def test_cart_item_factory_from_dict() -> None:
...
def test_cart_factory_from_dict() -> None:
