...
class ProductService(ProductServiceInterface):
    ...
    INVALID_DISCOUNT_MSG: str = "Discount percentage must be between {min_}% and {max_}%."
    ...
    def can_be_featured(self, product: Product) -> bool:
        return product.is_active and product.stock > self.FEATURED_MIN_STOCK and product.price > self.FEATURED_MIN_PRICE
